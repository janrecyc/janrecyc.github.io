/* ============================================================
   ...
   data or navigation yet:
     ...
     - Most "link" rows below don't navigate anywhere yet — give
       them an `onSelect` callback once their sub-page exists (see
       "เปลี่ยน PIN" / "จัดการผู้ใช้งาน" in the "บัญชี" section for a
       working example: `onSelect: () => { location.href = '...' }`).
       components/section-list.js's bindLinkRows() only wires up
       rows that have `onSelect` — the rest stay inert on purpose.
