/* ============================================================
   ...
   NOTE: "รับซื้อ" and "ประวัติการซื้อขาย" now each have their own
   real data shape + render path — pages/buy-tab.js and
   pages/history-tab.js respectively, wired in by pages/shop-page.js's
   SPECIAL_TABS router — instead of going through shop-item-list.js
   like "ขายออก"/"คัดแยก" still do. Their `tag` values here
   (null / 'history') are unused for those two, kept only so this
   array stays a uniform shape.
