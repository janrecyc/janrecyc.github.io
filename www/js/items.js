...
// ══════════════════════════════════════════════
const DEMO_ITEMS = [
  {id:1,  name:'เหล็กหนัก',          icon:'ph-wrench',         buy_price:4.50,  sell_price:5.80,  stock_qty:4200, unit:'กก.', cat:'metal'},
  {id:2,  name:'เหล็กบาง',           icon:'ph-pipe',           buy_price:2.80,  sell_price:3.50,  stock_qty:1800, unit:'กก.', cat:'metal'},
  {id:3,  name:'ทองแดง',             icon:'ph-coins',          buy_price:195,   sell_price:215,   stock_qty:320,  unit:'กก.', cat:'metal'},
  {id:4,  name:'อลูมิเนียม',         icon:'ph-steps',          buy_price:42,    sell_price:50,    stock_qty:960,  unit:'กก.', cat:'metal'},
  {id:5,  name:'สแตนเลส',            icon:'ph-gear-six',       buy_price:18,    sell_price:22,    stock_qty:550,  unit:'กก.', cat:'metal'},
  {id:6,  name:'กระดาษหนังสือพิมพ์', icon:'ph-newspaper',      buy_price:2.20,  sell_price:2.80,  stock_qty:3000, unit:'กก.', cat:'paper'},
  {id:7,  name:'กระดาษลัง',          icon:'ph-package',        buy_price:2.50,  sell_price:3.20,  stock_qty:5200, unit:'กก.', cat:'paper'},
  {id:8,  name:'กระดาษขาว',          icon:'ph-file-text',      buy_price:3.00,  sell_price:3.80,  stock_qty:1100, unit:'กก.', cat:'paper'},
  {id:9,  name:'พลาสติกขาว',         icon:'ph-cube',           buy_price:8.50,  sell_price:11,    stock_qty:780,  unit:'กก.', cat:'plastic'},
  {id:10, name:'ขวด PET',            icon:'ph-flask',          buy_price:6.00,  sell_price:8.00,  stock_qty:620,  unit:'กก.', cat:'plastic'},
  {id:11, name:'แก้วใส',             icon:'ph-square',         buy_price:1.20,  sell_price:1.60,  stock_qty:2100, unit:'กก.', cat:'glass'},
  {id:12, name:'สายไฟทองแดง',        icon:'ph-plug-charging',  buy_price:85,    sell_price:100,   stock_qty:180,  unit:'กก.', cat:'electric'},
  {id:13, name:'มอเตอร์เก่า',        icon:'ph-lightning',      buy_price:25,    sell_price:32,    stock_qty:95,   unit:'กก.', cat:'electric'},
];
...
function catIcon(slug){
  const icon = CATS.find(c=>c.slug===slug)?.icon || 'ph-package';
...
async function saveItem() {
  ...
  if (!SUPABASE_READY) {
    ...
    if (editingId !== null) {
      const idx = ALL_ITEMS.findIndex(x => x.id === editingId);
...
async function confirmDelete() {
  ...
  if (!SUPABASE_READY) {
    await new Promise(r => setTimeout(r, 500));
    ALL_ITEMS = ALL_ITEMS.filter(x => x.id !== deleteId);
